...
MSG_HELP_LINK="Uso: dfy link <paquete...>"
...
MSG_CREATE_HINT="Añade tus archivos de configuración en %s y ejecuta: dfy link %s"
MSG_CREATE_NEXT_STEPS="Próximos pasos:"
MSG_CREATE_NEXT_ADD="Añade dotfiles a %s y ejecuta: dfy link %s"
MSG_CREATE_NEXT_ADOPT="O adopta archivos existentes: dfy adopt %s"
...
MSG_INIT_CREATING="Inicializando repositorio de dotfiles en %s..."
MSG_INIT_SCAFFOLD="Creando archivos de ejemplo..."
MSG_INIT_REMOTE_HINT="Enlaza tu repositorio a un remoto cuando estés listo:"
